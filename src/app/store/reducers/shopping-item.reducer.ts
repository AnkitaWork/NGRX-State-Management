...
import { ShoppingAction, ShoppingActionTypes } from '../actions/shopping-item.action';
...
export function ShoppingReducers(state: ShoppingState = initialState, action: ShoppingAction) {
    switch (action.type) {
